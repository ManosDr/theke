...
shared with backend/app/services/region_contact_discovery.py via
theke_shared.contact_discovery - only the fetching (this file: sync
requests) and persistence (this file: raw psycopg from CLI args) differ,
tied to each service's own architecture. See KNOWN_DECISIONS.md's
