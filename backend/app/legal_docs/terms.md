...
Η Θήκη προσφέρεται σε επίπεδα συνδρομής ανά κάθετη υπηρεσία (Κατασκευών / Λογιστικής), όπως αναλυτικά περιγράφονται στη σελίδα τιμολόγησης [www.theke.ai/pricing — ή αντίστοιχο]. Ενδεικτικά:
