export const translations = {
  en: {
    ...
    "dash.member.noProjects": "No projects yet.",
  ...
  el: {
    ...
    "dash.member.noProjects": "Δεν υπάρχουν ακόμη έργα.",
    ...
    // chat
    "chat.placeholder": "Ρωτήστε π.χ. «Τι δικαιολογητικά χρειάζομαι για χτίσιμο μονοκατοικίας στην Καβάλα;»",
