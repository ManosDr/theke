...
Οι παρόντες Όροι Χρήσης («Όροι») διέπουν τη χρήση της πλατφόρμας Theke (Θήκη), συμπεριλαμβανομένων των δύο κάθετων υπηρεσιών της — Θήκη Κατασκευών και Θήκη Λογιστικής (από κοινού η «Υπηρεσία» ή «Θήκη») — η οποία παρέχεται από την εταιρεία **[ΕΠΩΝΥΜΙΑ ΙΚΕ, ΑΦΜ, ΓΕΜΗ, ΕΔΡΑ]** («εμείς», «η Εταιρεία»).
...
Η Θήκη προσφέρεται σε επίπεδα συνδρομής ανά κάθετη υπηρεσία (Κατασκευών / Λογιστικής), όπως αναλυτικά περιγράφονται στη σελίδα τιμολόγησης [www.theke.gr/pricing — ή αντίστοιχο]. Ενδεικτικά:

| Κάθετη Υπηρεσία | Πλάνο | Μηνιαία (ετήσια δέσμευση) | Μηνιαία (χωρίς δέσμευση) |
|---|---|---|---|
| Κατασκευών | Starter | €40,83 | €49 |
| Κατασκευών | Professional | €82,50 | €99 |
| Κατασκευών | Business | €165,83 | €199 |
...
- Σε ετήσια συνδρομή: **[ΝΑ ΑΠΟΦΑΣΙΣΤΕΙ]** — συνήθης πρακτική στην ελληνική αγορά SaaS είναι είτε (α) χωρίς επιστροφή για το αδιάθετο διάστημα, είτε (β) αναλογική επιστροφή μείον τυχόν έκπτωση που δόθηκε λόγω ετήσιας δέσμευσης. Πρότεινε να κλειδώσεις τη θέση σου εδώ πριν τη δημοσίευση — επηρεάζει άμεσα το μοντέλο ταμειακών ροών σου.
...
- Η συστηματική εξαγωγή, αντιγραφή, «scraping», ή χρήση αυτοματοποιημένων εργαλείων (bots, scrapers, crawlers) για μαζική εξαγωγή περιεχομένου της βάσης γνώσης της Θήκης, πέραν των απαντήσεων που λαμβάνετε στο πλαίσιο κανονικής, ανθρώπινης χρήσης της Υπηρεσίας.
...
Οι υποκείμενες επίσημες κανονιστικές πηγές (νόμοι, ΦΕΚ, αποφάσεις δημόσιων αρχών) **δεν αποτελούν ιδιοκτησία της Εταιρείας** — πρόκειται για επίσημα κείμενα του Ελληνικού Δημοσίου, εξαιρούμενα από την προστασία πνευματικής ιδιοκτησίας δυνάμει του άρθρου 2 §5 του Ν.2121/1993. Η Θήκη τα αναπαράγει και τα παραπέμπει (cites) ως δημόσια διαθέσιμο υλικό.
...
- Η Θήκη παρέχεται «ως έχει» («as is»), χωρίς καμία εγγύηση πληρότητας, ακρίβειας, ή καταλληλότητας για συγκεκριμένο σκοπό.
