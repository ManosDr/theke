...
Η theke είναι ένα εργαλείο που χρησιμοποιεί τεχνητή νοημοσύνη (retrieval-augmented generation) για να απαντά σε ερωτήσεις σχετικά με ελληνική νομοθεσία και διοικητικές διαδικασίες, βασιζόμενο σε επίσημες ελληνικές πηγές (ΦΕΚ, νόμους, αποφάσεις δημόσιων υπηρεσιών) με παραπομπές (citations) στις πηγές αυτές.
...
- Αποτελούν γενική νομική πληροφόρηση, όχι εξατομικευμένη επαγγελματική γνωμοδότηση για τη συγκεκριμένη περίπτωσή σας.
...
- Η χρήση της Υπηρεσίας για την εκπαίδευση, βελτίωση, ή δημιουργία ανταγωνιστικού προϊόντος τεχνητής νοημοσύνης ή βάσης νομικών δεδομένων.
...
- Της πρωτότυπης σύνθεσης, ανάλυσης, και επεξηγηματικού περιεχομένου που έχει συνταχθεί από την Εταιρεία πάνω στις νομικές πηγές.
...
Οι υποκείμενες επίσημες νομικές πηγές (νόμοι, ΦΕΚ, αποφάσεις δημόσιων αρχών) **δεν αποτελούν ιδιοκτησία της Εταιρείας**· πρόκειται για επίσημα κείμενα του Ελληνικού Δημοσίου, εξαιρούμενα από την προστασία πνευματικής ιδιοκτησίας δυνάμει του άρθρου 2 §5 του Ν.2121/1993. Η theke τα αναπαράγει και τα παραπέμπει (cites) ως δημόσια διαθέσιμο υλικό.
